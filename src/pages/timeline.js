...
const TimelinePage = () => (
    <div className="timeline">
        ...
        <Event title="10/06/2017: Jeyser Oxygen released - v2.0.0" color={colors.Major} size={15}
               text={'After months of work and refactor, Jeyser 2.0.0, with a lot of new features is released'}/>

        <Event title="04/02/2017: Docker installation" color={colors.Major} size={15}
        ...
        <Event title="22/01/2017: Very first pre-release of Jeyser Oxygen" color={colors.Minor} size={15}
        ...
        <Event title="08/11/2014: Incipio is licensed under the AGPLv3 licence" color={colors.Major} size={15}
               text={''}/>
